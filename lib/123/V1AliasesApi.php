...
class V1AliasesApi
{
     ...
     * Convert alias
     *
     * @param  \Booooza\DatatransClient\Model\AliasConvertRequest $alias_convert_request alias_convert_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\AliasConvertResponse|\Booooza\DatatransClient\Model\AliasesResponseBase
     */
     ...
     * Convert alias
     *
     * @param  \Booooza\DatatransClient\Model\AliasConvertRequest $alias_convert_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\AliasConvertResponse|\Booooza\DatatransClient\Model\AliasesResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function aliasesConvertWithHttpInfo($alias_convert_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\AliasConvertResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\AliasConvertResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Booooza\DatatransClient\Model\AliasesResponseBase' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\AliasesResponseBase', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Booooza\DatatransClient\Model\AliasConvertResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\AliasConvertResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\AliasesResponseBase',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\AliasInfoResponse|\Booooza\DatatransClient\Model\AliasesResponseBase
     */
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\AliasInfoResponse|\Booooza\DatatransClient\Model\AliasesResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function aliasesInfoWithHttpInfo($alias)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\AliasInfoResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\AliasInfoResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Booooza\DatatransClient\Model\AliasInfoResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\AliasInfoResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
