...
class V1ReconciliationsApi
{
     ...
     *
     * @param  \Booooza\DatatransClient\Model\BulkSaleReportRequest $bulk_sale_report_request bulk_sale_report_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\SaleReportResponse
     */
     ...
     * Bulk reporting of sales
     *
     * @param  \Booooza\DatatransClient\Model\BulkSaleReportRequest $bulk_sale_report_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\SaleReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkSaleReportWithHttpInfo($bulk_sale_report_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\SaleReportResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\SaleReportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Booooza\DatatransClient\Model\SaleReportResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\SaleReportResponse',
     ...
     * Report a sale
     *
     * @param  \Booooza\DatatransClient\Model\SaleReportRequest $sale_report_request sale_report_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\SaleReportResponse
     ...
     * Report a sale
     *
     * @param  \Booooza\DatatransClient\Model\SaleReportRequest $sale_report_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\SaleReportResponse, HTTP status code, HTTP response headers (array of strings)
