...
namespace Booooza\DatatransClient\Api;
...
use Booooza\DatatransClient\ApiException;
use Booooza\DatatransClient\Configuration;
use Booooza\DatatransClient\HeaderSelector;
...
class V1TransactionsApi
{
     ...
     *
     * @param  \Booooza\DatatransClient\Model\AuthorizeRequest $authorize_request authorize_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\AuthorizeResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
     */
     ...
     * Authorize a transaction
     *
     * @param  \Booooza\DatatransClient\Model\AuthorizeRequest $authorize_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\AuthorizeResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function authorizeWithHttpInfo($authorize_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\AuthorizeResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\AuthorizeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Booooza\DatatransClient\Model\TransactionsResponseBase' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\TransactionsResponseBase', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Booooza\DatatransClient\Model\AuthorizeResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\AuthorizeResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\TransactionsResponseBase',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Booooza\DatatransClient\Model\AuthorizeSplitRequest $authorize_split_request authorize_split_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\AuthorizeSplitResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
     */
     ...
     * @param  \Booooza\DatatransClient\Model\AuthorizeSplitRequest $authorize_split_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\AuthorizeSplitResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function authorizeSplitWithHttpInfo($transaction_id, $authorize_split_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\AuthorizeSplitResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\AuthorizeSplitResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
            ...
            $returnType = '\Booooza\DatatransClient\Model\AuthorizeSplitResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\AuthorizeSplitResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $transaction_id transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\CancelRequest $cancel_request Cancel a transaction (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $transaction_id transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\CreditRequest $credit_request Credit a transaction (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\CreditResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
     */
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\CreditResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function creditWithHttpInfo($transaction_id, $credit_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\CreditResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\CreditResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Booooza\DatatransClient\Model\CreditResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\CreditResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $transaction_id transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\IncreaseRequest $increase_request Increase authorization amount (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\IncreaseResponse
     */
    public function increase($transaction_id, $increase_request)
    {
        list($response) = $this->increaseWithHttpInfo($transaction_id, $increase_request);
        return $response;
    }
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\IncreaseResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function increaseWithHttpInfo($transaction_id, $increase_request)
    {
        $request = $this->increaseRequest($transaction_id, $increase_request);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\IncreaseResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\IncreaseResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Booooza\DatatransClient\Model\IncreaseResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\IncreaseResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function increaseAsync($transaction_id, $increase_request)
    {
        return $this->increaseAsyncWithHttpInfo($transaction_id, $increase_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function increaseAsyncWithHttpInfo($transaction_id, $increase_request)
    {
        $returnType = '\Booooza\DatatransClient\Model\IncreaseResponse';
        $request = $this->increaseRequest($transaction_id, $increase_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function increaseRequest($transaction_id, $increase_request)
    {
        // verify the required parameter 'transaction_id' is set
        if ($transaction_id === null || (is_array($transaction_id) && count($transaction_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // verify the required parameter 'increase_request' is set
        if ($increase_request === null || (is_array($increase_request) && count($increase_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $increase_request when calling increase'
            );
        }
        ...
        // for model (json/xml)
        if (isset($increase_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($increase_request));
            } else {
                $httpBody = $increase_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \Booooza\DatatransClient\Model\InitRequest $init_request init_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\InitResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
     */
     ...
     * Initialize a transaction
     *
     * @param  \Booooza\DatatransClient\Model\InitRequest $init_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\InitResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function initWithHttpInfo($init_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Booooza\DatatransClient\Model\InitResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\InitResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Booooza\DatatransClient\Model\InitResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\InitResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Booooza\DatatransClient\Model\ScreenRequest $screen_request Screen request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\AuthorizeResponse
     */
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\AuthorizeResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \Booooza\DatatransClient\Model\SecureFieldsInitRequest $secure_fields_init_request secure_fields_init_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\SecureFieldsInitResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
     */
     ...
     * Initialize a Secure Fields transaction
     *
     * @param  \Booooza\DatatransClient\Model\SecureFieldsInitRequest $secure_fields_init_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\SecureFieldsInitResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function secureFieldsInitWithHttpInfo($secure_fields_init_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Booooza\DatatransClient\Model\SecureFieldsInitResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\SecureFieldsInitResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Booooza\DatatransClient\Model\SecureFieldsInitResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\SecureFieldsInitResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $transaction_id transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\SecureFieldsUpdateRequest $secure_fields_update_request secure_fields_update_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\SecureFieldsUpdateRequest $secure_fields_update_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  int $transaction_id transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\SettleRequest $settle_request settle_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $transaction_id (required)
     * @param  \Booooza\DatatransClient\Model\SettleRequest $settle_request (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\StatusResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
     */
     ...
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Booooza\DatatransClient\Model\StatusResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function statusWithHttpInfo($transaction_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Booooza\DatatransClient\Model\StatusResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Booooza\DatatransClient\Model\StatusResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Booooza\DatatransClient\Model\StatusResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Booooza\DatatransClient\Model\StatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Booooza\DatatransClient\Model\ValidateRequest $validate_request Validate an alias (required)
     *
     * @throws \Booooza\DatatransClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Booooza\DatatransClient\Model\AuthorizeResponse|\Booooza\DatatransClient\Model\TransactionsResponseBase
