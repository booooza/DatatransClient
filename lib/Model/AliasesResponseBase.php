...
class AliasesResponseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\Booooza\DatatransClient\Model\AliasesError'
    ];
     ...
     * Gets error
     *
     * @return \Booooza\DatatransClient\Model\AliasesError|null
     */
     ...
     * Sets error
     *
     * @param \Booooza\DatatransClient\Model\AliasesError|null $error error
     *
     * @return self
     */
