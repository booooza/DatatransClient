...
/**
 * KlarnaInsurance Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaInsurance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaInsurance';
    ...
    const INSURANCE_TYPE_CANCELLATION = 'cancellation';
    const INSURANCE_TYPE_TRAVEL = 'travel';
    const INSURANCE_TYPE_CANCELLATION_TRAVEL = 'cancellation_travel';
    const INSURANCE_TYPE_BANKRUPTCY = 'bankruptcy';
     ...
     * @return string[]
     */
    public function getInsuranceTypeAllowableValues()
    {
        return [
            self::INSURANCE_TYPE_CANCELLATION,
            self::INSURANCE_TYPE_TRAVEL,
            self::INSURANCE_TYPE_CANCELLATION_TRAVEL,
            self::INSURANCE_TYPE_BANKRUPTCY,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getInsuranceTypeAllowableValues();
        if (!is_null($this->container['insurance_type']) && !in_array($this->container['insurance_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'insurance_type', must be one of '%s'",
                $this->container['insurance_type'],
     ...
     * Sets insurance_type
     *
     * @param string|null $insurance_type insurance_type
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getInsuranceTypeAllowableValues();
        if (!is_null($insurance_type) && !in_array($insurance_type, $allowedValues, true)) {
     ...
     *
     * @param double|null $insurance_price insurance_price
     *
     * @return self
     */
