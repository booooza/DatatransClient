...
class ReconciliationsError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => '\Booooza\DatatransClient\Model\ReconciliationsErrorCode',
        'message' => 'string'
    ];
     ...
     * Gets code
     *
     * @return \Booooza\DatatransClient\Model\ReconciliationsErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \Booooza\DatatransClient\Model\ReconciliationsErrorCode|null $code code
     *
     * @return self
     */
