...
/**
 * IncreaseRequest Class Doc Comment
 *
 * @category Class
 * @package  Booooza\DatatransClient
 * @author   OpenAPI Generator team
 ...
 */
class IncreaseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncreaseRequest';
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling IncreaseRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling IncreaseRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setRefno($refno)
    {
        if ((mb_strlen($refno) > 20)) {
            throw new \InvalidArgumentException('invalid length for $refno when calling IncreaseRequest., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($refno) < 1)) {
            throw new \InvalidArgumentException('invalid length for $refno when calling IncreaseRequest., must be bigger than or equal to 1.');
        }
