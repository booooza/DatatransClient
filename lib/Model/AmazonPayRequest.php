...
class AmazonPayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'seller_note' => 'string',
        'fraud_context' => '\Booooza\DatatransClient\Model\AmazonFraudContext'
    ];
     ...
     * Gets fraud_context
     *
     * @return \Booooza\DatatransClient\Model\AmazonFraudContext|null
     */
     ...
     * Sets fraud_context
     *
     * @param \Booooza\DatatransClient\Model\AmazonFraudContext|null $fraud_context fraud_context
     *
     * @return self
     */
