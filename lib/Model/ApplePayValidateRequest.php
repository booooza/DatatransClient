...
class ApplePayValidateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => 'string',
        'header' => '\Booooza\DatatransClient\Model\Header',
        'signature' => 'string',
        'version' => 'string'
    ];
     ...
     * Gets header
     *
     * @return \Booooza\DatatransClient\Model\Header|null
     */
     ...
     * Sets header
     *
     * @param \Booooza\DatatransClient\Model\Header|null $header header
     *
     * @return self
     */
