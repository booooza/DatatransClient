...
class OrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'articles' => '\Booooza\DatatransClient\Model\Article[]',
        'tax_amount' => 'int',
        'shipping_amount' => 'int',
        'discount_amount' => 'int'
    ];
     ...
     * Gets articles
     *
     * @return \Booooza\DatatransClient\Model\Article[]|null
     */
     ...
     * Sets articles
     *
     * @param \Booooza\DatatransClient\Model\Article[]|null $articles articles
     *
     * @return self
     */
