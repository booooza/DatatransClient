...
/**
 * KlarnaPassenger Class Doc Comment
 *
 * @category Class
 ...
 */
class KlarnaPassenger implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaPassenger';
     ...
     * Sets title
     *
     * @param string|null $title Mr, Mrs, Ms or blank if under 12 years
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string|null $first_name First name of the passenger
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name Last name of the passenger
     *
     * @return self
     */
