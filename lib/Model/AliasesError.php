...
class AliasesError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => '\Booooza\DatatransClient\Model\AliasesErrorCode',
        'message' => 'string'
    ];
     ...
     * Gets code
     *
     * @return \Booooza\DatatransClient\Model\AliasesErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \Booooza\DatatransClient\Model\AliasesErrorCode|null $code code
     *
     * @return self
     */
