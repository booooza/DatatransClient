...
class TransactionsResponseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\Booooza\DatatransClient\Model\TransactionsError'
    ];
     ...
     * Gets error
     *
     * @return \Booooza\DatatransClient\Model\TransactionsError|null
     */
     ...
     * Sets error
     *
     * @param \Booooza\DatatransClient\Model\TransactionsError|null $error error
     *
     * @return self
     */
