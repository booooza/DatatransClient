...
class MPXDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'alias' => 'string',
        'esr' => '\Booooza\DatatransClient\Model\EsrData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['esr'] = $data['esr'] ?? null;
    }
     ...
     * Gets esr
     *
     * @return \Booooza\DatatransClient\Model\EsrData|null
     */
    public function getEsr()
    {
        return $this->container['esr'];
    }

    /**
     * Sets esr
     *
     * @param \Booooza\DatatransClient\Model\EsrData|null $esr esr
     *
     * @return self
     */
    public function setEsr($esr)
    {
        $this->container['esr'] = $esr;
