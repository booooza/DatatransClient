...
class KlarnaEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'company' => 'string',
        'genre' => 'string',
        'arena' => '\Booooza\DatatransClient\Model\KlarnaArena',
        'start' => '\DateTime',
        'end' => '\DateTime',
     ...
     * Gets arena
     *
     * @return \Booooza\DatatransClient\Model\KlarnaArena|null
     */
     ...
     * Sets arena
     *
     * @param \Booooza\DatatransClient\Model\KlarnaArena|null $arena arena
     *
     * @return self
     */
