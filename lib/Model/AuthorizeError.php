...
class AuthorizeError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => '\Booooza\DatatransClient\Model\TransactionsErrorCode',
        'message' => 'string'
    ];
     ...
     * Gets code
     *
     * @return \Booooza\DatatransClient\Model\TransactionsErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \Booooza\DatatransClient\Model\TransactionsErrorCode|null $code code
     *
     * @return self
     */
