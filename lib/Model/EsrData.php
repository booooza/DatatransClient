 ...
 */
class EsrData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EsrData';
    ...
    protected static $openAPITypes = [
        'bank_name' => 'string',
        'bank_address' => 'string',
        'beneficiary_first_line' => 'string',
        'beneficiary_second_line' => 'string',
        'beneficiary_third_line' => 'string',
        'beneficiary_fourth_line' => 'string',
        'bank_account' => 'string',
        'payer_first_line' => 'string',
        'payer_second_line' => 'string',
        'payer_third_line' => 'string',
        'payer_fourth_line' => 'string',
        'reference_line1' => 'string',
        'reference_line2' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'bank_name' => null,
        'bank_address' => null,
        'beneficiary_first_line' => null,
        'beneficiary_second_line' => null,
        'beneficiary_third_line' => null,
        'beneficiary_fourth_line' => null,
        'bank_account' => null,
        'payer_first_line' => null,
        'payer_second_line' => null,
        'payer_third_line' => null,
        'payer_fourth_line' => null,
        'reference_line1' => null,
        'reference_line2' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'beneficiary_first_line' => 'beneficiaryFirstLine',
        'beneficiary_second_line' => 'beneficiarySecondLine',
        'beneficiary_third_line' => 'beneficiaryThirdLine',
        'beneficiary_fourth_line' => 'beneficiaryFourthLine',
        'bank_account' => 'bankAccount',
        'payer_first_line' => 'payerFirstLine',
        'payer_second_line' => 'payerSecondLine',
        'payer_third_line' => 'payerThirdLine',
        'payer_fourth_line' => 'payerFourthLine',
        'reference_line1' => 'referenceLine1',
        'reference_line2' => 'referenceLine2'
    ];
    ...
    protected static $setters = [
        ...
        'beneficiary_first_line' => 'setBeneficiaryFirstLine',
        'beneficiary_second_line' => 'setBeneficiarySecondLine',
        'beneficiary_third_line' => 'setBeneficiaryThirdLine',
        'beneficiary_fourth_line' => 'setBeneficiaryFourthLine',
        'bank_account' => 'setBankAccount',
        'payer_first_line' => 'setPayerFirstLine',
        'payer_second_line' => 'setPayerSecondLine',
        'payer_third_line' => 'setPayerThirdLine',
        'payer_fourth_line' => 'setPayerFourthLine',
        'reference_line1' => 'setReferenceLine1',
        'reference_line2' => 'setReferenceLine2'
    ];
    ...
    protected static $getters = [
        ...
        'beneficiary_first_line' => 'getBeneficiaryFirstLine',
        'beneficiary_second_line' => 'getBeneficiarySecondLine',
        'beneficiary_third_line' => 'getBeneficiaryThirdLine',
        'beneficiary_fourth_line' => 'getBeneficiaryFourthLine',
        'bank_account' => 'getBankAccount',
        'payer_first_line' => 'getPayerFirstLine',
        'payer_second_line' => 'getPayerSecondLine',
        'payer_third_line' => 'getPayerThirdLine',
        'payer_fourth_line' => 'getPayerFourthLine',
        'reference_line1' => 'getReferenceLine1',
        'reference_line2' => 'getReferenceLine2'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['beneficiary_first_line'] = $data['beneficiary_first_line'] ?? null;
        $this->container['beneficiary_second_line'] = $data['beneficiary_second_line'] ?? null;
        $this->container['beneficiary_third_line'] = $data['beneficiary_third_line'] ?? null;
        $this->container['beneficiary_fourth_line'] = $data['beneficiary_fourth_line'] ?? null;
        $this->container['bank_account'] = $data['bank_account'] ?? null;
        $this->container['payer_first_line'] = $data['payer_first_line'] ?? null;
        $this->container['payer_second_line'] = $data['payer_second_line'] ?? null;
        $this->container['payer_third_line'] = $data['payer_third_line'] ?? null;
        $this->container['payer_fourth_line'] = $data['payer_fourth_line'] ?? null;
        $this->container['reference_line1'] = $data['reference_line1'] ?? null;
        $this->container['reference_line2'] = $data['reference_line2'] ?? null;
    }
    ...
    /**
     * Gets beneficiary_first_line
     *
     * @return string|null
     */
    public function getBeneficiaryFirstLine()
    {
        return $this->container['beneficiary_first_line'];
    }

    /**
     * Sets beneficiary_first_line
     *
     * @param string|null $beneficiary_first_line beneficiary_first_line
     *
     * @return self
     */
    public function setBeneficiaryFirstLine($beneficiary_first_line)
    {
        $this->container['beneficiary_first_line'] = $beneficiary_first_line;

        return $this;
    }

    /**
     * Gets beneficiary_second_line
     *
     * @return string|null
     */
    public function getBeneficiarySecondLine()
    {
        return $this->container['beneficiary_second_line'];
    }

    /**
     * Sets beneficiary_second_line
     *
     * @param string|null $beneficiary_second_line beneficiary_second_line
     *
     * @return self
     */
    public function setBeneficiarySecondLine($beneficiary_second_line)
    {
        $this->container['beneficiary_second_line'] = $beneficiary_second_line;

        return $this;
    }

    /**
     * Gets beneficiary_third_line
     *
     * @return string|null
     */
    public function getBeneficiaryThirdLine()
    {
        return $this->container['beneficiary_third_line'];
    }

    /**
     * Sets beneficiary_third_line
     *
     * @param string|null $beneficiary_third_line beneficiary_third_line
     *
     * @return self
     */
    public function setBeneficiaryThirdLine($beneficiary_third_line)
    {
        $this->container['beneficiary_third_line'] = $beneficiary_third_line;

        return $this;
    }

    /**
     * Gets beneficiary_fourth_line
     *
     * @return string|null
     */
    public function getBeneficiaryFourthLine()
    {
        return $this->container['beneficiary_fourth_line'];
    }

    /**
     * Sets beneficiary_fourth_line
     *
     * @param string|null $beneficiary_fourth_line beneficiary_fourth_line
     *
     * @return self
     */
    public function setBeneficiaryFourthLine($beneficiary_fourth_line)
    {
        $this->container['beneficiary_fourth_line'] = $beneficiary_fourth_line;
    ...
    /**
     * Gets payer_first_line
     *
     * @return string|null
     */
    public function getPayerFirstLine()
    {
        return $this->container['payer_first_line'];
    }

    /**
     * Sets payer_first_line
     *
     * @param string|null $payer_first_line payer_first_line
     *
     * @return self
     */
    public function setPayerFirstLine($payer_first_line)
    {
        $this->container['payer_first_line'] = $payer_first_line;

        return $this;
    }

    /**
     * Gets payer_second_line
     *
     * @return string|null
     */
    public function getPayerSecondLine()
    {
        return $this->container['payer_second_line'];
    }

    /**
     * Sets payer_second_line
     *
     * @param string|null $payer_second_line payer_second_line
     *
     * @return self
     */
    public function setPayerSecondLine($payer_second_line)
    {
        $this->container['payer_second_line'] = $payer_second_line;

        return $this;
    }

    /**
     * Gets payer_third_line
     *
     * @return string|null
     */
    public function getPayerThirdLine()
    {
        return $this->container['payer_third_line'];
    }

    /**
     * Sets payer_third_line
     *
     * @param string|null $payer_third_line payer_third_line
     *
     * @return self
     */
    public function setPayerThirdLine($payer_third_line)
    {
        $this->container['payer_third_line'] = $payer_third_line;

        return $this;
    }

    /**
     * Gets payer_fourth_line
     *
     * @return string|null
     */
    public function getPayerFourthLine()
    {
        return $this->container['payer_fourth_line'];
    }

    /**
     * Sets payer_fourth_line
     *
     * @param string|null $payer_fourth_line payer_fourth_line
     *
     * @return self
     */
    public function setPayerFourthLine($payer_fourth_line)
    {
        $this->container['payer_fourth_line'] = $payer_fourth_line;

        return $this;
    }

    /**
     * Gets reference_line1
     *
     * @return string|null
     */
    public function getReferenceLine1()
    {
        return $this->container['reference_line1'];
    }

    /**
     * Sets reference_line1
     *
     * @param string|null $reference_line1 reference_line1
     *
     * @return self
     */
    public function setReferenceLine1($reference_line1)
    {
        $this->container['reference_line1'] = $reference_line1;

        return $this;
    }

    /**
     * Gets reference_line2
     *
     * @return string|null
     */
    public function getReferenceLine2()
    {
        return $this->container['reference_line2'];
    }

    /**
     * Sets reference_line2
     *
     * @param string|null $reference_line2 reference_line2
     *
     * @return self
     */
    public function setReferenceLine2($reference_line2)
    {
        $this->container['reference_line2'] = $reference_line2;
