 ...
 */
class Dcc implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets currency
     *
     * @param string|null $currency The DCC currency
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int|null $amount The DCC amount
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param double|null $rate The DCC rate
     *
     * @return self
     */
     ...
     * Sets markup
     *
     * @param double|null $markup The DCC markup
     *
     * @return self
     */
