...
/**
 * IncreaseResponse Class Doc Comment
 *
 * @category Class
 * @package  Booooza\DatatransClient
 * @author   OpenAPI Generator team
 ...
 */
class IncreaseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncreaseResponse';
    ...
    protected static $setters = [
        'increased_amount' => 'setIncreasedAmount'
    ];
    ...
    protected static $getters = [
        'increased_amount' => 'getIncreasedAmount'
    ];
    ...
    {
        $this->container['increased_amount'] = $data['increased_amount'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['increased_amount'] === null) {
            $invalidProperties[] = "'increased_amount' can't be null";
        }
    ...
    /**
     * Gets increased_amount
     *
     * @return int
     */
    public function getIncreasedAmount()
    {
        return $this->container['increased_amount'];
    }

    /**
     * Sets increased_amount
     *
     * @param int $increased_amount The amount of the transaction in the currency’s smallest unit. For example use 1000 for CHF 10.00. Total authorized amount including initial authorization and subsequent authorization increases.
     *
     * @return self
     */
    public function setIncreasedAmount($increased_amount)
    {
        $this->container['increased_amount'] = $increased_amount;
