...
class AirlineDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pnr' => 'string',
        'issue_date' => '\DateTime',
        'tickets' => '\Booooza\DatatransClient\Model\Ticket[]'
    ];
     ...
     * Gets tickets
     *
     * @return \Booooza\DatatransClient\Model\Ticket[]|null
     */
     ...
     * Sets tickets
     *
     * @param \Booooza\DatatransClient\Model\Ticket[]|null $tickets A list of tickets for this purchase. Note: PAP only supports one ticket.
     *
     * @return self
     */
