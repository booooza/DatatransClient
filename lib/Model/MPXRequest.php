...
class MPXRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'alias' => 'alias',
        'invoice_on_delivery' => 'invoiceOnDelivery'
    ];
    ...
    protected static $setters = [
        'alias' => 'setAlias',
        'invoice_on_delivery' => 'setInvoiceOnDelivery'
    ];
    ...
    protected static $getters = [
        'alias' => 'getAlias',
        'invoice_on_delivery' => 'getInvoiceOnDelivery'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoice_on_delivery'] = $data['invoice_on_delivery'] ?? null;
    }
    ...
    /**
     * Gets invoice_on_delivery
     *
     * @return bool|null
     */
    public function getInvoiceOnDelivery()
    {
        return $this->container['invoice_on_delivery'];
    }

    /**
     * Sets invoice_on_delivery
     *
     * @param bool|null $invoice_on_delivery If set to `true`, The customers bank details (ESR data) are available from the Status API
     *
     * @return self
     */
    public function setInvoiceOnDelivery($invoice_on_delivery)
    {
        $this->container['invoice_on_delivery'] = $invoice_on_delivery;
